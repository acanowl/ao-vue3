...
.pd-t-8
  todo-input(v-model="inputValue" @[EVENT_ADD_NAME]="addHandle")
.pd-t-8(v-for="([key, title]) in todoGroupOpts" :key="key")
  todo-group(:title="title" :items="todoGroupList[key]" @refresh="refreshHandle" @clear="clearHandle")
</template>
